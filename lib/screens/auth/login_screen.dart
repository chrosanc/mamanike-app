  ...
  Future<void> _login() async {
    try {
      ...
      if (e.code == 'user-not-found') {
        CherryToast.error(title: const Text("Akun tidak ditemukan. Silakan daftar."),
        animationType: AnimationType.fromTop).show(context);
      } else if (e.code == 'wrong-password') {
        CherryToast.error(title: const Text("Password Salah"),
        animationType: AnimationType.fromTop).show(context);
      } else {
        CherryToast.error(title: Text("Error: ${e.message}"),
        animationType: AnimationType.fromTop).show(context);
      }
    }
  }
